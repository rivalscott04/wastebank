...
const { User, Transaction, WasteCollection, WastePrice, WasteCategory } = require('../models');
const auth = require('../middleware/auth');
const { Op } = require('sequelize');

// Endpoint aktivitas terbaru dashboard - DISABLED karena error
...
//     const [users, transactions, collections] = await Promise.all([
