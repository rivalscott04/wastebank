...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('Users', {
      ...
      role: {
        type: Sequelize.ENUM('admin', 'nasabah'),
    ...
    await queryInterface.createTable('WasteCollections', {
      ...
      status: {
        type: Sequelize.ENUM('pending', 'confirmed', 'processing', 'completed', 'cancelled'),
    ...
    await queryInterface.createTable('Transactions', {
      ...
      payment_method: {
        type: Sequelize.ENUM('cash', 'bank_transfer', 'e-wallet'),
        allowNull: false
      },
      payment_status: {
    ...
    await queryInterface.createTable('RewardRedemptions', {
      ...
      status: {
        type: Sequelize.ENUM('pending', 'processed', 'completed', 'cancelled'),
        defaultValue: 'pending'
      },
      createdAt: {
        allowNull: false,
